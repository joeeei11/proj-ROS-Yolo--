...
(cl:defmethod cl:initialize-instance :after ((m <SetMode-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetMode-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name excavator_msgs-srv:<SetMode-request> is deprecated: use excavator_msgs-srv:SetMode-request instead.")))

(cl:ensure-generic-function 'mode-val :lambda-list '(m))
(cl:defmethod mode-val ((m <SetMode-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader excavator_msgs-srv:mode-val is deprecated.  Use excavator_msgs-srv:mode instead.")
  (mode m))
...
(cl:defmethod cl:initialize-instance :after ((m <SetMode-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetMode-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name excavator_msgs-srv:<SetMode-response> is deprecated: use excavator_msgs-srv:SetMode-response instead.")))
...
(cl:defmethod message-val ((m <SetMode-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader excavator_msgs-srv:message-val is deprecated.  Use excavator_msgs-srv:message instead.")
  (message m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetMode-response>)))
  ...
  "excavator_msgs/SetModeResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetMode-response)))
  "Returns string type for a service object of type 'SetMode-response"
  "excavator_msgs/SetModeResponse")
